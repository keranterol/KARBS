...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/keranterol/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/keranterol/KARBS/master/progs.csv"
